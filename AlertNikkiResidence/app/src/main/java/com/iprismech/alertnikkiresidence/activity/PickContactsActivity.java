...
public class PickContactsActivity extends BaseAbstractActivity implements View.OnClickListener {
...
//                    ApplicationController.getInstance().handleEvent(AppConstants.EventIds.LAUNCH_VIEW_INVITE_GUEST_SCREEN,bundle);
    ...
    private class LoadContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = ProgressDialog.show(PickContactsActivity.this, "Loading Contacts",
                    "Please Wait...");
...
*/
                adapter = null;
                if (adapter == null) {
                    adapter = new ContactsAdapter(PickContactsActivity.this, contactList);
                ...
                Toast.makeText(PickContactsActivity.this, "There are no contacts.",
