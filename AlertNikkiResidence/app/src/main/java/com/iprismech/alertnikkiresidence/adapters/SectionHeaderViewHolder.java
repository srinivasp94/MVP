...
public class SectionHeaderViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public SectionHeaderViewHolder(View itemView, HeaderViewHolderCallback callback) {
        super(itemView);
//        sectionTitle = itemView.findViewById(R.id.textview_name);
        ...
        arrowUp = ContextCompat.getDrawable(itemView.getContext(), R.drawable.right_arrow);
        arrowDown = ContextCompat.getDrawable(itemView.getContext(), R.drawable.leftarrow_white);
