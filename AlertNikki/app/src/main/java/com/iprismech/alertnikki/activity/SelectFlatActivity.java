...
import com.iprismech.alertnikki.adapters.FlatsAdapter;
...
public class SelectFlatActivity extends AppCompatActivity implements RetrofitResponseListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        rview = findViewById(R.id.rview_select_flat);
    ...
    private void sendrequest(String id) {
        ...
        flatListRequest.admin_id = SharedPrefsUtils.getInstance(SelectFlatActivity.this).getAdmin();
