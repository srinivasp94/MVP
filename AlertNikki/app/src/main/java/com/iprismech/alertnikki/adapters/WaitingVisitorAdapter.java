...
//      if Residence not responding to call or message allow to check
        ...
        if (member.type.equalsIgnoreCase("Guest")
            ...
            viewHolder.b_check.setVisibility(View.GONE);
                ...
                && member.security_accept_status.equalsIgnoreCase("0")||member.type.equalsIgnoreCase("Cab")
                && member.security_accept_status.equalsIgnoreCase("0")||member.type.equalsIgnoreCase("Repair & Maintenance")
                && member.security_accept_status.equalsIgnoreCase("0")||member.type.equalsIgnoreCase("Others")
